...
/**
 * Created by matheusoliveira on 05/09/2017.
 */
...
public class EditProductDialog extends DialogFragment {
    ...
    private Dialog createDialog(final Context context) {
        ...
        final int idProduct = mBundle.getInt(Constants.PRODUCT_ID);
        String nameProduct = mBundle.getString(Constants.PRODUCT_NAME);
        int qntProduct = mBundle.getInt(Constants.PRODUCT_QNT);
        float priceProduct = mBundle.getFloat(Constants.PRODUCT_VALUE);
        final int position = mBundle.getInt(Constants.POSITION);
        ...
        qntItem.setText(String.valueOf(qntProduct));
        valueItem.setText(NumberFormat.getCurrencyInstance().format((priceProduct)));
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nameItem.getText().toString().equals("")) {
                    ...
                    sqlQuery.updateProduct(idProduct, name, qnt, price);
                    Product product = new Product(idProduct, name, qnt, price);
                    mActivity.refreshUpdateList(product, position);
                    mDialog.dismiss();
                } else {
